...
- [ ] **Airwindows port (5): Galactic.** The lush option. Per original research: 3-stage cascaded 4x4 FDN with 12 fixed-tap delays + tiny 256-sample modulated pre-delay. ~488 KB stereo. LOW port risk. Package: `house`.
- [ ] **Airwindows port (6): Verbity.** Feedforward-with-one-feedback topology — single instance spans zero-feedback slapback through infinite tail. Same memory footprint as Galactic but different parameter feel. Package: `house`.
