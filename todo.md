...
- [ ] Gate rework: current FX_GATE is a crude on/off tied to step progress -- feels arbitrary. Want GrossBeat-style rhythmic volume chop: clock-aware pattern of cuts across the step (e.g. 1/4, 1/8, 1/16 subdivisions), param picks the pattern or the on/off ratio. Should read as a rhythmic gate, not "output muted for the back half of the step".
