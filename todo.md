...
- [-] **Airwindows port (1): kWoodRoom.** Active. Phase A (house package scaffold) shipped at `house-0.1.0.1`; Phase 0 (KWoodRoomDSP + Smoketest harness) shipped at `house-0.1.0.2`. **Awaiting hardware smoke-test pass before Phase 1.** Plan: `planning/kwoodroom-port-plan.md`.
