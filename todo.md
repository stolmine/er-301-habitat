...
- [ ] **Airwindows port (4): BrightAmbience3.** Gated bright halo. **Use the "3", not the original BrightAmbience** — the original is the CPU-hungry naive-prime-tap version. The "3" is the undersampled rebuild. Package: `house`. Smoketest gate.
