...
|---|---|---|---|---|
| V/oct | Pitch | n/a | 0 | 1 V/oct pitch input, C4 at 0 V |
...
| Control | Type | Range / Options | Default | What it does |
|---|---|---|---|---|
| Gate | Gate | n/a | n/a | Trigger/gate input; fires the internal envelope + LPG |
...
| Trigger | Gate | n/a | n/a | Fires a single grain |
| Freeze | Gate (toggle) | n/a | off | Stops recording; the buffer becomes fixed material |
...
| Control | Type | Range / Options | Default | What it does |
|---|---|---|---|---|
| Strum | Gate | n/a | n/a | Rising edge excites the resonator |
| V/oct | Pitch | n/a | 0 | 1 V/oct pitch input |
...
| Control | Type | Range / Options | Default | What it does |
|---|---|---|---|---|
| Grids | GridsCircle | n/a | n/a | Two-ply circular step display; follows the running pattern |
...
| Reset | Gate | n/a | n/a | Rising edge returns to step 0 |
...
| Control | Type | Range / Options | Default | What it does |
|---|---|---|---|---|
| mod | BranchMeter | n/a | 1.0 gain | Modulator sub-chain and its level (clamped at -59.9 dB); part of the unit's mute group |
...
| Control | Type | Range / Options | Default | What it does |
|---|---|---|---|---|
| Gate | Gate | n/a | n/a | Gate input; opens the envelope and drives the exciters |
...
| Control | Type | Range / Options | Default | What it does |
|---|---|---|---|---|
| Clock | Gate | n/a | n/a | External clock input; the generator is silent until the first edge |
| Reset | Gate | n/a | n/a | Rising edge resets the generator |
...
| Control | Type | Range / Options | Default | What it does |
|---|---|---|---|---|
| Clock | Gate | n/a | n/a | External clock input |
| Reset | Gate | n/a | n/a | Rising edge resets the generator |
