...
## Full bisect record for the Cortex-A8 NEON defense

The path to landing `-fno-tree-vectorize` took a full evening of bisecting through 14 mi versions (1.0.3.5 through 1.0.3.18). Full record: `planning/mi-mode-switch-aapcs-barrier-resolution.md`. Top-priority memory rule: `feedback_disable_tree_vectorize_am335x`.
