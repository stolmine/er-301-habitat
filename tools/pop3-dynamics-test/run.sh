#!/usr/bin/env bash
# Measures the REAL mods/house/atoms/Pop3Dynamics.h with shipping flags.
set -e
cd "$(dirname "$0")"
mkdir -p stub/od
...
g++ -O3 -ffast-math -fno-tree-vectorize -msse4 -std=gnu++11 -w \
    -Istub -I../../mods/house/atoms main.cpp -o /tmp/pop3-dynamics-test -lm
exec /tmp/pop3-dynamics-test
