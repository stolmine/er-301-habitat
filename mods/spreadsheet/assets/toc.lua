return {
  ...
  author = "stolmine",
  name = "spreadsheet",
  keyword = "sequencer, filter, delay, spreadsheet",
  units = {
    ...
    { title = "Presse",   moduleName = "MultibandCompressor", category = "Spreadsheet", keywords = "compressor, multiband, dynamics, sidechain, effect" }
  }
}
