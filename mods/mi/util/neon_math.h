// NEON 4-lane polynomial math primitives for the mi package.
// Mirror of mods/spreadsheet/util/neon_math.h with mi:: namespace so
// plaits / rings / etc. consumers can include without colliding with
// the spreadsheet copy (each package links separately). Same
// polynomial coefficients, so emu A/B is identical across packages.
//
