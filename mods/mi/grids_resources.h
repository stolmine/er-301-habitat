#pragma once
// Pattern data extracted from Mutable Instruments Grids (MIT License)
// 25 pattern nodes, each 96 bytes (3 instruments x 32 steps)
...
// 5x5 grid of pattern node pointers
// X selects column (0-4), Y selects row (0-4)
...
static const int kStepsPerPattern = 32;
