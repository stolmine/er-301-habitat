...
# Marbles DSP sources (follow symlinks)
MARBLES_CC = $(shell find -L $(MOD_DIR)/random -name '*.cc')
MARBLES_CC += $(shell find -L $(MOD_DIR)/ramp -name '*.cc')
MARBLES_CC += $(MOD_DIR)/resources.cc
