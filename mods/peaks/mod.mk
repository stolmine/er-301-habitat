...
# DMC Peaks DSP sources (local copies)
PEAKS_CC = $(MOD_DIR)/peaks/modulations/lfo.cc \
           $(MOD_DIR)/peaks/modulations/multistage_envelope.cc \
           $(MOD_DIR)/peaks/drums/bass_drum.cc \
           $(MOD_DIR)/peaks/drums/snare_drum.cc \
           $(MOD_DIR)/peaks/drums/high_hat.cc \
           $(MOD_DIR)/peaks/drums/fm_drum.cc \
           $(MOD_DIR)/peaks/number_station/number_station.cc \
           $(MOD_DIR)/peaks/number_station/bytebeats.cc \
           $(MOD_DIR)/peaks/resources.cc
...
OBJECTS += $(addprefix $(OUT_DIR)/,$(PEAKS_CC:%.cc=%.o))
...
# Includes — local peaks/ FIRST to shadow eurorack's peaks/
INCLUDES = $(MOD_DIR)/peaks $(MOD_DIR) mods $(SDKPATH) $(SDKPATH)/arch/$(ARCH) $(SDKPATH)/emu $(EURORACK)
...
CFLAGS += -Wno-unused-variable -Wno-unused-parameter -Wno-sign-compare -Wno-missing-field-initializers
