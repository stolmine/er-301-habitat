...
function FmLfo:init(args)
  args.title = "FM LFO"
  args.mnemonic = "FL"
  Unit.init(self, args)
end

function FmLfo:onLoadGraph(channelCount)
  local op = self:addObject("op", libpeaks.FmLfo())
...
function FmLfo:onLoadViews()
  return {
    ...
    p3 = GainBias {
      button = "fm", description = "FM Amount",
    ...
    p4 = GainBias {
      button = "f.rt", description = "FM Rate",
