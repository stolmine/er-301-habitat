...
function FmDrum:init(args)
  args.title = "FM Drum"
  args.mnemonic = "FM"
  Unit.init(self, args)
end

function FmDrum:onLoadGraph(channelCount)
  local op = self:addObject("op", libpeaks.FmDrum())
