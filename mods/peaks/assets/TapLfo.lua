...
function TapLfo:init(args)
  args.title = "Tap LFO"
  args.mnemonic = "TL"
  Unit.init(self, args)
end

function TapLfo:onLoadGraph(channelCount)
  local op = self:addObject("op", libpeaks.TapLfo())
...
function TapLfo:onLoadViews()
  return {
    ...
    p4 = GainBias {
      button = "phase", description = "Phase",
