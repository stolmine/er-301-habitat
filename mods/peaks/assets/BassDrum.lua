...
local BassDrum = Class {}
BassDrum:include(Unit)

function BassDrum:init(args)
  args.title = "Bass Drum"
  args.mnemonic = "BD"
  Unit.init(self, args)
end

function BassDrum:onLoadGraph(channelCount)
  local op = self:addObject("op", libpeaks.BassDrum())
