...
void DecayEnvelope::setSampleRate(o3Float newSampleRate)
{
...
void DecayEnvelope::setDecayTimeConstant(o3Float newTimeConstant)
{
...
bool DecayEnvelope::endIsReached(o3Float threshold)
{
  if( y < threshold )
    return true;
  else
