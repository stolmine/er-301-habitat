...
namespace rosic
{
  ...
  */
  ...
  public:
    ...
    void setDecayTimeConstant(o3Float newTimeConstant);
    ...
    o3Float getDecayTimeConstant() const { return tau; }

    /** True, if output is below some threshold. */
    bool endIsReached(o3Float threshold);  
  ...
  protected:
    ...
    o3Float c;             // coefficient for multiplicative accumulation
    o3Float y;             // previous output
    o3Float yInit;         // initial yalue for previous output (= y/c)
    o3Float tau;           // time-constant (in milliseconds)
    o3Float fs;            // sample-rate
  ...
  INLINE o3Float DecayEnvelope::getSample()
  {
    y *= c;
    return y;
  }
