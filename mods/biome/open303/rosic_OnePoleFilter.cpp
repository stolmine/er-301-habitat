...
void OnePoleFilter::setSampleRate(o3Float newSampleRate)
{
...
void OnePoleFilter::setCutoff(o3Float newCutoff)
{
...
void OnePoleFilter::setShelvingGain(o3Float newGain)
{
  if( newGain > 0.0 )
  {
...
void OnePoleFilter::setShelvingGainInDecibels(o3Float newGain)
{
  setShelvingGain(dB2amp(newGain));
}

void OnePoleFilter::setCoefficients(o3Float newB0, o3Float newB1, o3Float newA1)
{
  b0 = newB0;
  b1 = newB1;
  a1 = newA1;
...
void OnePoleFilter::setInternalState(o3Float newX1, o3Float newY1)
{
  x1 = newX1;
  y1 = newY1;
}
...
void OnePoleFilter::calcCoeffs()
{
  ...
  case LOWPASS: 
    {
      ...
      o3Float x = exp( -2.0 * PI * cutoff * sampleRateRec); 
      b0 = 1-x;
      b1 = 0.0;
      a1 = x;
    }
  ...
  case LOWSHELV:
    {
      // formula from DAFX:
      o3Float c = 0.5*(shelvingGain-1.0);
      o3Float t = tan(PI*cutoff*sampleRateRec);
      o3Float a;
      if( shelvingGain >= 1.0 )
        a = (t-1.0)/(t+1.0);
      else
