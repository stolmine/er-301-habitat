...
# Warps DSP sources (follow symlinks)
WARPS_CC = $(shell find -L $(MOD_DIR)/dsp -name '*.cc')
WARPS_CC += $(MOD_DIR)/resources.cc
...
# Includes — mod dir first to shadow warps/drivers/debug_pin.h
